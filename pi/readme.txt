The files arduino_serial.py and udp_text.py are just for testing purposes.
...
I intend to flesh out these docs and add mroe useful comments in the near future.
